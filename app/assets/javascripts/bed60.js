...
(function ($) {
    ...
    function setMagnificPopup() {
        ...
        if (magnific_photo.length) {
            magnific_photo.magnificPopup({ type: "image" });
        }
        ...
        if (magnific_iframe.length) {
            magnific_iframe.magnificPopup({ type: "iframe" });
        }
        if (magnific_inline.length) {
            magnific_inline.magnificPopup({ type: "inline" });
        }
        if (magnific_ajax.length) {
            magnific_ajax.magnificPopup({ type: "ajax" });
        }
    }
    function setFitvids() {
    ...
    jQuery(document).ready(function ($) {
        ...
        if (parallaxbg > 0) {
            ...
            jarallax(document.querySelectorAll(".nt-jarallax.mobile-parallax-off"), { disableParallax: /iPad|iPhone|iPod|Android/, disableVideo: /iPad|iPhone|iPod|Android/ });
        }
 ...
 */ !(function (o) {
    ...
    function (e, j, S) {
        ...
        (function (e) {
            ...
            var s = -1 < navigator.userAgent.indexOf("MSIE ") || -1 < navigator.userAgent.indexOf("Trident/index.html") || -1 < navigator.userAgent.indexOf("Edge/index.html"),
                r = (function () {
                            ...
                            },
                            {
                                ...
                                value: function () {
                                    var e = this,
                                        ...
                                        l = 0;
                                    return (
                                        i && ((a = n < 0 ? n * Math.max(o, v) : n * (o + v)), 1 < n ? (r = Math.abs(a - v)) : n < 0 ? (r = a / n + Math.abs(a)) : (r += Math.abs(v - o) * (1 - n)), (a /= 2)),
                            ...
                            if (
                                ...
                                return "local" !== t.type
                                    ? (t.getImageURL(function (e) {
                                      ...
                                      !1)
                                    : ((o.image.src = "data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7"), !0);
                        } else
                            o.defaultInitImgResult ||
                                t.getImageURL(function (e) {
            ...
            return (
                ...
                (e.prototype.onDeviceOrientation = function (t) {
                    if (null !== t.gamma && null !== t.beta) {
                        ...
                        null !== this.updateCall && cancelAnimationFrame(this.updateCall), (this.event = { clientX: a + this.left, clientY: l + this.top }), (this.updateCall = requestAnimationFrame(this.updateBind));
                    }
                }),
                ...
                (e.prototype.updateGlareSize = function () {
                    this.glare && Object.assign(this.glareElement.style, { width: "" + 2 * this.element.offsetWidth, height: "" + 2 * this.element.offsetWidth });
                }),
                ...
                var k,
                    ...
                    U = (function () {
                        ...
                        return (
                            ...
                            (o = m && parseFloat(T.substr(T.indexOf("Version/index.html") + 8, 2)) < 6),
    ...
    (r.prototype.TYPES = ["line", "ellipse", "circle", "polygon", "polyline", "rect"]),
        ...
        (i.prototype.setElement = function (e, r) {
            ...
            if (((this.parentEl = e), r && r.file)) {
                ...
                return i.addEventListener("load", t), i.open("get-in-touch/index.html", r.file), void i.send();
            }
        ...
        (i.prototype.setOptions = function (t) {
            ...
            if (
                ...
                (this.isIE = -1 !== window.navigator.userAgent.indexOf("MSIE") || -1 !== window.navigator.userAgent.indexOf("Trident/index.html") || -1 !== window.navigator.userAgent.indexOf("Edge/index.html")),
...
(function ($) {
    ...
    var nHtmlNode = document.documentElement,
        ...
        nContainerNull = $(".container-null").length,
    ...
    AOS.init({ offset: 120, delay: 100, duration: 450, easing: "ease-in-out-quad", once: true, disable: "mobile" });
    function _header() {
        ...
        if (bNavAnchor) {
            jBodyNode.scrollspy({ target: nHeader, offset: iHeaderHeight + 1 });
        }
    ...
    function _sticked() {
        $(window).scroll(function () {
            var top_bar = $(".top-bar.is-sticky").length;
        ...
        function _countInit() {
            jCounter.each(function (i, counter) {
                ...
                if ($this.is_on_screen() && !$this.hasClass("animate")) {
                    $this.addClass("animate").countTo({ from: 0, speed: 2000, refreshInterval: 100 });
                }
            });
        }
            ...
            $.getScript(apiURL, function (data, textStatus, jqxhr) {
                maps.each(function () {
                    var current_map = $(this),
                        ...
                        myOptions = { zoom: 14, center: latlng, mapTypeId: google.maps.MapTypeId.ROADMAP, mapTypeControl: false, scrollwheel: false, draggable: true, panControl: false, zoomControl: false, disableDefaultUI: true },
                        stylez = [{ featureType: "all", elementType: "all", stylers: [{ saturation: -100 }] }];
                    var map = new google.maps.Map(current_map[0], myOptions);
                    var mapType = new google.maps.StyledMapType(stylez, { name: "Grayscale" });
                    map.mapTypes.set("Grayscale", mapType);
                    map.setMapTypeId("Grayscale");
                    var marker = new google.maps.Marker({ map: map, icon: { size: new google.maps.Size(59, 69), origin: new google.maps.Point(0, 0), anchor: new google.maps.Point(0, 69), url: point }, position: latlng });
        ...
        jLink.on("touchend click", function (e) {
            ...
            if (location.pathname.replace(/^\//, "") == this.pathname.replace(/^\//, "") && location.hostname == this.hostname) {
                ...
                if (target.length) {
                    $("html,body")
                        .stop()
                        .animate({ scrollTop: target.offset().top - iHeaderHeight }, 1000);
                }
    ...
    $.fn.is_on_screen = function () {
        var viewport = { top: jWindow.scrollTop(), left: jWindow.scrollLeft() };
...
window.addComment = (function (s) {
    ...
    function r(e) {
        if (i && ((u = I(p.cancelReplyId)), (f = I(p.commentFormId)), u)) {
            ...
            for (
                ...
                (n = r[d]).addEventListener("touchstart", l), n.addEventListener("click", l);
        }
    }
    function a(e) {
    ...
    return (
        i && "loading" !== y.readyState ? t() : i && s.addEventListener("DOMContentLoaded", t, !1),
        {
            init: r,
                    ...
                    try {
                        for (var c = 0; c < f.elements.length; c++)
                            if (
                                ((o = f.elements[c]),
                                (i = !1),
                                "getComputedStyle" in s ? (a = s.getComputedStyle(o)) : y.documentElement.currentStyle && (a = o.currentStyle),
                                ((o.offsetWidth <= 0 && o.offsetHeight <= 0) || "hidden" === a.visibility) && (i = !0),
...
function wavify(e, t) {
    void 0 === t && (t = {});
    var n,
        o = Object.assign({}, { container: t.container ? t.container : "body", height: 200, amplitude: 100, speed: 0.15, bones: 3, color: "rgba(255,255,255, 0.20)" }, t),
        i = e,
        ...
        if (n) {
            ...
            u = TweenMax.to(i, o.speed, {
                attr: {
                    d: (function (e) {
                        var t = "M " + e[0].x + " " + e[0].y,
                            n = { x: (e[1].x - e[0].x) / 2, y: e[1].y - e[0].y + e[0].y + (e[1].y - e[0].y) };
                        t += " C " + n.x + " " + n.y + " " + n.x + " " + n.y + " " + e[1].x + " " + e[1].y;
                        for (var o = n, i = -1, c = 1; c < e.length - 1; c++) {
                            Math.sqrt(o.x * o.x + o.y * o.y);
                            var l = { x: e[c].x - o.x + e[c].x, y: e[c].y - o.y + e[c].y };
    ...
    function g() {
        l && (v(), u.kill(), (u = TweenMax.set(i, { x: 0, y: 0, rotation: 0, opacity: 0, clearProps: "all", attr: { d: "M0,0", fill: "" } })), window.removeEventListener("resize", x), (l = !1));
    }
    return (
        l || ((u = TweenMax.set(i, { attr: { fill: o.color } })), m(), window.addEventListener("resize", x)),
        {
            reboot: function (e) {
                var t;
                g(), void 0 !== typeof e && ((t = e), (o = Object.assign({}, o, t))), (u = TweenMax.set(i, { attr: { fill: o.color } })), m(), window.addEventListener("resize", x);
            },
            play: m,
            pause: v,
            kill: g,
            updateColor: function (e) {
                void 0 === typeof e.timing && (e.timing = 1),
                    void 0 === typeof e.color && (e.color = o.color),
                    (u = TweenMax.to(i, parseInt(e.timing), {
                        attr: { fill: e.color },
                        onComplete: function () {
